...
from routes import deals, export, identity, kpis, management, scoring
...
app = FastAPI(
    ...
    description="Pipeline priorizado por valor em risco, com isolamento de dados por papel de acesso.",
    version="0.1.0",
    lifespan=lifespan,
)
