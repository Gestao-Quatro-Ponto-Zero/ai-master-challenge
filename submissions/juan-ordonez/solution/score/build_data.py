...
Saída:
    ...
    ../../process-log/golden_deals.md       — deals de referência pro process log
"""
...
def main() -> None:
    ...
    web_dir = solution_dir / "web"
    process_log_dir = solution_dir.parent / "process-log"  # submissions/juan-ordonez/process-log/
    ...
    # ========================================================================
    # GOLDEN FILE (deals de referência pro process log)
    # ========================================================================
...
def write_golden_file(scored: list[dict], path: Path) -> None:
    """
    Seleciona deals de referência e escreve em markdown.
    ...
    with path.open("w", encoding="utf-8") as f:
        f.write("# Golden deals — casos de referência\n\n")
        f.write(
