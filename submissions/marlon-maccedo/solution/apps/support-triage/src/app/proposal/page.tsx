...
import { ProposalAutomation, ProposalLimitations, ProposalSectionSkeleton } from '@/components/ProposalSections'
...
export default async function ProposalPage() {
  ...
  return (
    <div className="space-y-10 max-w-3xl">
      ...
      {/* O que automatizar / não — gerado por IA sobre os dados reais */}
      <Suspense fallback={<ProposalSectionSkeleton label="recomendações de automação" />}>
        <ProposalAutomation
          overview={overview}
          bottlenecks={bottlenecks}
          channelStats={channelStats}
      ...
      {/* Limitações — gerado por IA sobre os dados reais */}
      <Suspense fallback={<ProposalSectionSkeleton label="limitações" />}>
        <ProposalLimitations
          overview={overview}
          bottlenecks={bottlenecks}
          channelStats={channelStats}
