...
| F3 edba2342 / F8 8a66fb81 / F-05 a306a10d — contagens sem qualificador | Captions → **"snapshot no fechamento da It08"** + "re-derivar na It09/10" (README §7, evidence-index §3/§4/§5/§9/§10, report It08 §4); snapshot atualizado por glob/git: 9 gates, 27 revisores, 10 correções, 20 prompts, 20 reports, 9 summaries, 123 arquivos, 29 commits, verifier 88 PASS |
...
- Fixer do gate It08 em 3 commits (escopo 100% `submissions/jose-nascimento/`; sem amend/force/config/destrutivo; autor do candidato, identidade verificada; push validado local == origin; tree limpa):
  ...
  3. **`docs: finalize iteration 08 gate snapshot counts`** (`4c48713`) — contagens do snapshot re-derivadas do git real (29 commits do candidato; fixer do gate It08 = 10ª correção).
