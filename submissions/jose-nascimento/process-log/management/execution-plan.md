...
- **Validações:** leitura crítica do relatório por outro agente (parte da revisão 3x — gate PENDING); conferência de 5 números contra o pipeline (3 spot checks manuais executados); `git diff --check`.
