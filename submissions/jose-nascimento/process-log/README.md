...
| Correções sequenciais commitadas | **10** | 8 fixers de gate (`9907024`, `b9823da`, `9378a86`, `12ff47c`, `1517a73`, `e0c6b7e`, `fa6572f`, `a1e99cb`) + 1 correção visual pós-gate It04 (`617e4ac`) + 1 fixer do gate It08 (3 commits: `78933e6`, `a93178b`, `4c48713`) — `git log` |
...
| Commits do candidato | **29** (25 no HEAD `a1e99cb` → 26 no commit do process log → 29 após os 3 commits do fixer do gate It08) | `git log --author="Jose Nascimento"` |
