...
| ACT-03 | Instrumentação de dados: milestone de ativação, reason estruturado, timestamps alinhados, CSAT com cobertura, lens unificada | Next | ALTA como habilitadora | CSAT com nota: 58,8% hoje -> >= 90%; reason 'unknown' 15,8% -> < 5%; uso em janela 22,3% -> >= 90%; milestone de ativação 0% -> 100% dos novos signups | M | 4 semanas (primeiros campos) | Data/Product Eng |
...
|---|---|---|---|---|---|---|---|---|---|
| ACT-01 | conservador | 0.3393 | 80 | 27.10 | 10.0% | 2.70 | 621.981 | 21.104 | premissa de planejamento (10/20/30% de redução relativa); NÃO derivada do lift; a ser testada pelo experimento ACT-01 |
| ACT-01 | base | 0.4301 | 80 | 34.40 | 20.0% | 6.90 | 621.981 | 53.497 | premissa de planejamento (10/20/30% de redução relativa); NÃO derivada do lift; a ser testada pelo experimento ACT-01 |
| ACT-01 | ambicioso | 0.5417 | 80 | 43.30 | 30.0% | 13 | 621.981 | 101.078 | premissa de planejamento (10/20/30% de redução relativa); NÃO derivada do lift; a ser testada pelo experimento ACT-01 |
| ACT-01 | sens-inc-lo | 0.3393 | 80 | 27.10 | 20.0% | 5.40 | 621.981 | 42.208 | sensibilidade de incidência (precision regra D, cutoffs 90d) |
| ACT-01 | sens-inc-base | 0.4301 | 80 | 34.40 | 20.0% | 6.90 | 621.981 | 53.497 | sensibilidade de incidência (precision regra D, cutoffs 90d) |
| ACT-01 | sens-inc-hi | 0.5417 | 80 | 43.30 | 20.0% | 8.70 | 621.981 | 67.385 | sensibilidade de incidência (precision regra D, cutoffs 90d) |
...
| ACT-01 | annualized | 0.4301 | 320 | 137.60 | 20.0% | 27.50 | 2.487.924 | 213.987 | annualized MRR-equivalent exposure — aritmética (4 coortes trimestrais do estoque atual); NÃO é forecast |
...
| SC-F08 | t14_backtest_temporal.csv | colunas mínimas presentes | PASS | t14_backtest_temporal.csv: 6 colunas exigidas presentes |
