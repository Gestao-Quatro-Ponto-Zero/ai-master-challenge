...
<div class="flex h-screen min-h-0 bg-background overflow-hidden selection:bg-primary/30">
	<Sidebar />
	<main class="flex-1 flex flex-col relative overflow-hidden bg-background pb-20 md:pb-0 min-h-0">
		{@render children()}
	</main>
