...
CREATE UNIQUE INDEX IF NOT EXISTS managers_name_region_unique
  ON managers (name, regional_office_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS sales_agents_name_region_unique
  ON sales_agents (name, regional_office_id);
