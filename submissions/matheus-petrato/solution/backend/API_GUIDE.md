...
- **Gestora (Manager):** `camila@g4.com` / `admin123` (Nome no CSV: **Dustin Brinkmann**)
- **Vendedor (Seller):** `joao@g4.com` / `admin123` (Nome no CSV: **Anna Snelling**)

> [!TIP]
> Para que os dados apareçam para esses usuários, use os nomes **Dustin Brinkmann**, **Anna Snelling** e a região **Central** nos seus arquivos CSV de importação.
