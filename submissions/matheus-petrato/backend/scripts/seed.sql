...
('018e3000-0001-7000-8000-000000000001', 'South'),
('018e3000-0001-7000-8000-000000000002', 'North'),
('018e3000-0001-7000-8000-000000000003', 'East'),
('018e3000-0001-7000-8000-000000000004', 'West')
ON CONFLICT (name) DO NOTHING;

-- 2. Managers
INSERT INTO managers (id, name, regional_office_id) VALUES 
('018e3000-0003-7000-8000-000000000001', 'Camila Manager', '018e3000-0001-7000-8000-000000000001')
ON CONFLICT (id) DO NOTHING;

-- 3. Sales Agents (Sellers)
INSERT INTO sales_agents (id, name, manager_id, regional_office_id) VALUES 
('018e3000-0004-7000-8000-000000000001', 'Joao Seller', '018e3000-0003-7000-8000-000000000001', '018e3000-0001-7000-8000-000000000001')
ON CONFLICT (id) DO NOTHING;
